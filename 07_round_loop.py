...
# Geometry Assessment Component 7
# This Component asks the user whether they would like to calculate the measurements of any further shapes,
# ... where, if the user answers affirmatively, the round is looped.
